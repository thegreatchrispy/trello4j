...
public class TrelloURL {
	...
	public static final String BOARD_DELETE_URL = "https://api.trello.com/1/boards/{0}";
	...
	public static final String CARD_POST_MEMBER_URL = "https://api.trello.com/1/cards/{0}/idMembers";
	public static final String CARD_DELETE_URL = "https://api.trello.com/1/cards/{0}";
